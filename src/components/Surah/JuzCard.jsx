...
export default function JuzCard({ juz }) {
    return (
        <Link
            to={`/juz/${juz.juz}`}
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                    Mulai: Surah {juz.start.surah} Ayat {juz.start.ayat}
                </p>
            </div>

            <div className="flex items-center gap-3 shrink-0">
                <span className="font-medium text-slate-600 dark:text-slate-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    {juz.name}
                </span>
